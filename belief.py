...
class BeliefDriveItEnv(DriveItEnv):
    def __init__(self, car=Car(), bots=None, time_limit=10, noisy=True, random_position=True, bot_speed_deviation=0.0, normalize=True):
        super().__init__(car, bots, time_limit, noisy, random_position, bot_speed_deviation)
