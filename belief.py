...
class BeliefDriveItEnv(DriveItEnv):
    def __init__(self, car=Car(), bots=None, time_limit=10, noisy=True, random_position=True, normalize=True):
        super().__init__(car, bots, time_limit, noisy, random_position)
